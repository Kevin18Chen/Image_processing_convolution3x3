...
#
# Generated by Vivado on Thu Jun 15 14:06:12 +0800 2023
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="D:/record_CNN/convolution512x512_V2/convolution512x512_V2.cache/compile_simlib/activehdl"
  fi
